...
│                         fnirs_cognitive_load and configuration for tools like black
│
...
│
└── fnirs_cognitive_load   <- Source code for use in this project.
    │
    ├── __init__.py             <- Makes fnirs_cognitive_load a Python module
    │
